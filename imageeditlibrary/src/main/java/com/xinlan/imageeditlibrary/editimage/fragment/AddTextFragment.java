...
public class AddTextFragment extends Fragment implements TextWatcher {
    ...
    private LinearLayout backToMenu;// 返回主菜单
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        backToMenu = (LinearLayout) mainView.findViewById(R.id.back_to_main);
        ...
        text_color_panel = (LinearLayout) mainView.findViewById(R.id.text_color_panel);
        return mainView;
    }
    ...
    public void onActivityCreated(Bundle savedInstanceState) {
        ...
        text_color_panel.setOnClickListener(new SelectColorBtnClick());
    ...
    private void changeTextColor(int newColor) {
        ...
        mTextColorSelector.setColorFilter(mTextColor);
