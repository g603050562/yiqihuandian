...
import com.xinlan.imageeditlibrary.PubFunction;
...
public class FliterListFragment extends Fragment {
    ...
    private LinearLayout backBtn;// 返回主菜单按钮
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        backBtn = (LinearLayout) mainView.findViewById(R.id.back_to_main);
    ...
    private final class SaveImageTask extends AsyncTask<Bitmap, Void, Boolean> {
        ...
        protected void onPreExecute() {
            super.onPreExecute();
            dialog = EditImageActivity.getLoadingDialog(getActivity(),R.string.saving_image, false);
            dialog.show();
        }
    }// end inner class
