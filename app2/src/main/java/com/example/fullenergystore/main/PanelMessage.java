...
public class PanelMessage extends Fragment{
	...
	public View onCreateView(LayoutInflater inflater, ViewGroup container,Bundle savedInstanceState) {
		...
		view = inflater.inflate(R.layout.panel_message,container,false);
	...
	public void onResume() {
		...
		if(!pageHidden){
			...
			fragmentTransaction.replace(R.id.panelMessagePanel, new PanelMessagePanel());
	...
	public void onHiddenChanged(boolean hidden) {
		...
		if (hidden) {
			...
			FragmentManager fragmentManager = getChildFragmentManager();
			FragmentTransaction fragmentTransaction = fragmentManager.beginTransaction();
			fragmentTransaction.replace(R.id.panelMessagePanel, new NoneFragement());
			fragmentTransaction.addToBackStack(null);
			fragmentTransaction.commit();
		}else{
			pageHidden = false;
