 ...
 */
@EActivity(R.layout.green_userinfo_certified_edit)
public class GreenUserInfoCertifiedEdit extends Activity {
    ...
    @Click
    void submit() {
        httpCertifiedAdd(car_id.getText().toString(),bar_id.getText().toString());
        progressDialog.show();
    }
    ...
    @Background
    void httpCertifiedAdd(String carID, String bettaryID) {
        ...
        list.add(new BasicNameValuePair("battery_cat", "A"));
        ...
        try {
            ...
            if (httpResponse.getStatusLine().getStatusCode() == HttpStatus.SC_OK) {
                ...
                renturnError("服务器错误：httpCertifiedAdd");
            }
        } catch (Exception e) {
            renturnError("json解析错误：httpCertifiedAdd");
        }
    }
