...
public class PanelMineAppoItem extends Fragment implements OnScrollListener {
	...
	private Handler panelMineAppoItemSuccessHandler, panelMineAppoItemErrorHandler, panelMineAppoItemUnknownHandler,
			panelMineAppoItemSuccessReHandler, turnToLogin;
	private List<Map<String, Object>> list = new ArrayList<Map<String, Object>>();
	private int count_anli_page = 2;
	private int current_page = 1;
	private int[] item = new int[]{R.layout.panel_mine_appo_item_0,R.layout.panel_mine_appo_item_1,R.layout.panel_mine_appo_item_2};

	public PanelMineAppoItem() {
		// TODO Auto-generated constructor stub
	}

	public PanelMineAppoItem(int catid) {
		this.catid = catid;
	}

	@Override
	public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
		view = inflater.inflate(R.layout.panel_mine_appo_item, container, false);
		fragement = this;
	...
	private void init() {
		listView = (PullToRefreshListView) view.findViewById(R.id.panelMineAppoListview);
		...
		listView.setOnRefreshListener(new OnRefreshListener<ListView>() {
			...
			public void onRefresh(PullToRefreshBase<ListView> refreshView) {
				...
				if (PubFunction.isNetworkAvailable(getActivity())) {
					init();
					handler();
					th = new HttpPanelMineAppoItem(catid, preferences, panelMineAppoItemSuccessHandler,
	...
	public void onScrollStateChanged(AbsListView view, int scrollState) {
		if (scrollState == OnScrollListener.SCROLL_STATE_IDLE) {
			if ((view.getLastVisiblePosition() == view.getCount() - 1) && current_page < count_anli_page) {
				if (PubFunction.isNetworkAvailable(getActivity())) {
					th_re = new HttpPanelMineAppoItem(catid, preferences, panelMineAppoItemSuccessHandler,
							panelMineAppoItemErrorHandler, panelMineAppoItemUnknownHandler, panelMineAppoItemSuccessReHandler,
...
class HttpPanelMineAppoItem extends Thread {
	...
	public HttpPanelMineAppoItem(int catid, SharedPreferences preferences, Handler SuccessHandler, Handler ErrorHandler,
