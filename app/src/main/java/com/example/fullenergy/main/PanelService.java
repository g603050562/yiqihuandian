...
public class PanelService extends Fragment {

    private View view;

    @Override
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        view = inflater.inflate(R.layout.panel_service, container, false);
    ...
    private void showPanel(){
        ...
        fragmentTransaction.replace(R.id.panelServicePanel, new PanelServiceIndex_());
