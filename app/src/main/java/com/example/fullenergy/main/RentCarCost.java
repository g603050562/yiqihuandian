...
public class RentCarCost extends Fragment {
    ...
    @ViewById
    TextView rentcar_cost_button,mouth_show,totol_pay,agreement;
    @ViewById
    LinearLayout turn_to_index,page_return,time_long;
    ...
    @Click
    void agreement(){
        Intent intent = new Intent(getActivity(),RentBarAgreement_.class);
    ...
    void time_long(){
        ...
        View view = inflater.inflate(R.layout.centcar_index_mouthpicker, null);
        TextView textView_1 = (TextView) view.findViewById(R.id.mouth_1);
        ...
        TextView textView_2 = (TextView) view.findViewById(R.id.mouth_2);
        ...
        TextView textView_3 = (TextView) view.findViewById(R.id.mouth_3);
        ...
        TextView textView_4 = (TextView) view.findViewById(R.id.mouth_4);
        ...
        TextView textView_5 = (TextView) view.findViewById(R.id.mouth_5);
        ...
        TextView textView_6 = (TextView) view.findViewById(R.id.mouth_6);
    ...
    void writeDateDase(String rent_duration){
        SharedPreferences sharedPreferences = getActivity().getSharedPreferences("rentCarOrder", Activity.MODE_PRIVATE);
        SharedPreferences.Editor editor = sharedPreferences.edit();
        editor.putString("rent_duration", rent_duration);
        editor.commit();
        mouth_show.setText(rent_duration + "个月/" + 300 * Integer.parseInt(rent_duration) + "元");
        totol_pay.setText(Integer.toString(300 * Integer.parseInt(rent_duration)) + "元");
    }
    ...
    @Background
    void uploadorder(){
        String path = PubFunction.www + "api.php/Order/order";
        ...
        SharedPreferences preferences_order = getActivity().getSharedPreferences("rentCarOrder", Activity.MODE_PRIVATE);
        String rent_time = preferences_order.getString("rent_time", null);
        String address_id = preferences_order.getString("address_id",null);
        String car_id = preferences_order.getString("car_id",null);
        String deposit = preferences_order.getString("deposit",null);
        String rent_duration = preferences_order.getString("rent_duration",null);

        list.add(new BasicNameValuePair("rent_time", rent_time));
        list.add(new BasicNameValuePair("business_id", address_id));
        list.add(new BasicNameValuePair("car_type_id", car_id));
        list.add(new BasicNameValuePair("deposit", "0"));
        list.add(new BasicNameValuePair("rent_duration", rent_duration));
        ...
        try {
            ...
            if (httpResponse.getStatusLine().getStatusCode() == HttpStatus.SC_OK) {
                ...
                if (fragment != null) {
                    if (code.equals("0")) {
                        JSONObject returnOrder = jsonObject.getJSONObject("data");
                        getTypSuccess(returnOrder);
                        ...
                        if (messageString.equals("已有成功订单,请扫码取车!")) {
                            haveOrder();
                        }else{
                            getTypError(messageString);
                        }
    ...
    @UiThread
    void getTypSuccess(JSONObject jsonObject){
        progressDialog.dismiss();
        try {
            name =  jsonObject.getString("car_name");
