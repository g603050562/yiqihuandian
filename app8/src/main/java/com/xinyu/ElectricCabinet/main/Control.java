...
public class Control extends FragmentActivity implements View.OnClickListener{
    ...
    private LinearLayout adv_panel;
    ...
    private Handler getReturnTextHandler,sendMessageHandler,setDateHandler,httpUploadBatteryInfoSuccessHandler,httpErrorHandler,httpInputOldBarSuccessHandler,httpInputOldBarErrorHandler,OutputNewBarSuccessHandler,setWifiInfo,setAdvPanelHandler,QcodeRequestSuccessHandler;
    ...
    //屏保 + 二维码 参数
    private int define_wait_time = 10;
    ...
    private void init() {
        ...
        adv_panel = (LinearLayout) this.findViewById(R.id.adv_panel);
...
//                    String BID = list.get(7)+list.get(8)+list.get(9)+list.get(10)+list.get(11)+list.get(12);
                    ...
                    if(local == 1){
                        ...
                        if(is_null_ba[local-1] == 3){
                            b1_t5.setText("找不到充电机");
                        }else{
